...
router.get('/:id', auth('ADMIN'), FundController.getFundById);
router.patch('/:id', auth('ADMIN'), validateRequest(fundValidation.update), FundController.updateFund);
router.patch('/:id/status', auth('ADMIN'), validateRequest(fundValidation.updateStatus), FundController.updateFund);
